...
def voltages_gui(mini=False):
    station = qc.Station.default
    if hasattr
    # Must set sim_gui.voltage_parameters
    start_gui(VoltageControlDialog, 'sim_gui',
              parameters=voltages_gui.voltage_parameters,
              mini=mini)
...
class VoltageControlDialog(QDialog):
    ...
    def initUI(self):
        ...
        for k, parameter in enumerate(self.parameters):
            ...
            SIM928_dialog = VoltageSourceDialog(parameter, idx=idx, mini=self.mini)
